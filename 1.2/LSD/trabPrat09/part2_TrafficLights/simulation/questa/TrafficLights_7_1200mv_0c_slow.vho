...
SIGNAL \timer_fsm|s_counter[4]~0_combout\ : std_logic;
...
-- Equation(s):
-- \clk_div_1hz|Equal0~5_combout\ = (\clk_div_1hz|s_divCounter\(5) & (\clk_div_1hz|s_divCounter\(2) & (\clk_div_1hz|s_divCounter\(4) & \clk_div_1hz|s_divCounter\(3))))
...
-- Equation(s):
-- \clk_div_1hz|s_divCounter~3_combout\ = (!\clk_div_1hz|Equal0~11_combout\ & \clk_div_1hz|Add0~30_combout\)
...
-- Equation(s):
-- \clk_div_1hz|Equal0~7_combout\ = (\clk_div_1hz|s_divCounter\(25) & (\clk_div_1hz|s_divCounter\(23) & (!\clk_div_1hz|s_divCounter\(18) & !\clk_div_1hz|s_divCounter\(24))))
...
-- Equation(s):
-- \clk_div_1hz|Equal0~0_combout\ = (!\clk_div_1hz|s_divCounter\(30) & (!\clk_div_1hz|s_divCounter\(28) & (!\clk_div_1hz|s_divCounter\(27) & !\clk_div_1hz|s_divCounter\(29))))
...
-- Equation(s):
-- \clk_div_1hz|Equal0~3_combout\ = (!\clk_div_1hz|s_divCounter\(8) & (!\clk_div_1hz|s_divCounter\(7) & (!\clk_div_1hz|s_divCounter\(9) & !\clk_div_1hz|s_divCounter\(10))))
...
-- Equation(s):
-- \clk_div_1hz|clkOut~0_combout\ = (!\clk_div_1hz|s_divCounter\(25) & (!\clk_div_1hz|s_divCounter\(23) & (\clk_div_1hz|s_divCounter\(18) & \clk_div_1hz|s_divCounter\(24))))
...
-- Equation(s):
-- \clk_div_1hz|Equal0~6_combout\ = (\clk_div_1hz|s_divCounter\(0) & (\clk_div_1hz|Equal0~5_combout\ & (\clk_div_1hz|s_divCounter\(1) & \clk_div_1hz|Equal0~4_combout\)))
...
-- Equation(s):
-- \main_fsm|Selector6~0_combout\ = (\timer_fsm|s_cntZero~q\ & (((\main_fsm|s_currentState.TGreen1~q\)))) # (!\timer_fsm|s_cntZero~q\ & ((\main_fsm|s_currentState.TYellow1~q\) # ((\SW[0]~input_o\ & \main_fsm|s_currentState.TGreen1~q\))))
...
-- Equation(s):
-- \main_fsm|sync_proc~11_combout\ = (\main_fsm|s_currentState.TGreen1~q\ & (!\main_fsm|s_currentState.TYellow1~q\ & ((\SW[0]~input_o\) # (\timer_fsm|s_cntZero~q\)))) # (!\main_fsm|s_currentState.TGreen1~q\ & (((\main_fsm|s_currentState.TYellow1~q\ & 
...
-- Equation(s):
-- \main_fsm|sync_proc~10_combout\ = (\SW[0]~input_o\ & (\main_fsm|s_currentState.TGreen1~q\)) # (!\SW[0]~input_o\ & (\timer_fsm|s_cntZero~q\ & (\main_fsm|s_currentState.TGreen1~q\ $ (\main_fsm|s_currentState.TRed2~q\))))
...
-- Equation(s):
-- \main_fsm|s_stateChanged~2_combout\ = ((\timer_fsm|s_cntZero~q\ & (\main_fsm|s_currentState.TYellow2~q\ $ (\main_fsm|s_currentState.TRed2~q\)))) # (!\KEY[0]~input_o\)
...
-- Equation(s):
-- \main_fsm|s_stateChanged~3_combout\ = ((\main_fsm|sync_proc~11_combout\) # ((\main_fsm|sync_proc~10_combout\) # (\main_fsm|s_stateChanged~2_combout\))) # (!\main_fsm|s_currentState.TInit~q\)
...
-- Equation(s):
-- \main_fsm|s_stateChanged~1_combout\ = (\main_fsm|sync_proc~9_combout\) # (\main_fsm|s_currentState.TIntermit~q\ $ (((\main_fsm|Selector4~0_combout\) # (\main_fsm|Selector4~1_combout\))))
...
-- Equation(s):
-- \main_fsm|s_stateChanged~4_combout\ = (!\main_fsm|s_stateChanged~3_combout\ & (!\main_fsm|s_stateChanged~0_combout\ & !\main_fsm|s_stateChanged~1_combout\))
...
-- Equation(s):
-- \timer_fsm|Add1~0_combout\ = (!\main_fsm|s_stateChanged~q\ & (!\main_fsm|s_currentState.TYellow1~q\ & !\main_fsm|s_currentState.TYellow2~q\))
...
PORT MAP (
	...
	ena => \timer_fsm|s_counter[4]~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
\timer_fsm|s_counter[4]~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \timer_fsm|s_counter[4]~0_combout\ = (((!\timer_fsm|s_cntZero~0_combout\) # (!\timer_fsm|s_cntZero~1_combout\)) # (!\KEY[0]~input_o\)) # (!\timer_fsm|s_counter\(7))
...
PORT MAP (
	...
	combout => \timer_fsm|s_counter[4]~0_combout\);
...
-- Equation(s):
-- \main_fsm|WideOr6~combout\ = (\main_fsm|s_currentState.TRed2~q\) # ((\main_fsm|s_currentState.TGreen2~q\) # (\main_fsm|s_currentState.TRed1~q\))
...
-- Equation(s):
-- \timer_fsm|Add1~4_combout\ = (!\main_fsm|s_stateChanged~q\ & (\main_fsm|WideOr6~combout\ $ (((\main_fsm|s_currentState.TYellow1~q\) # (\main_fsm|s_currentState.TYellow2~q\)))))
...
-- Equation(s):
-- \timer_fsm|Add1~7_combout\ = (\KEY[0]~input_o\ & (!\timer_fsm|Add1~4_combout\ & ((!\main_fsm|s_stateChanged~q\) # (!\timer_fsm|Add1~5_combout\))))
...
-- Equation(s):
-- \timer_fsm|Add1~8_combout\ = (!\main_fsm|s_stateChanged~q\ & (!\main_fsm|s_currentState.TYellow1~q\ & (!\main_fsm|s_currentState.TYellow2~q\ & !\main_fsm|WideOr6~combout\)))
...
-- Equation(s):
-- \timer_fsm|Add1~11_combout\ = (\KEY[0]~input_o\ & (!\timer_fsm|Add1~8_combout\ & ((!\main_fsm|s_stateChanged~q\) # (!\timer_fsm|Add1~9_combout\))))
...
-- Equation(s):
-- \timer_fsm|s_cntZero~1_combout\ = (\timer_fsm|s_counter\(3) & (\timer_fsm|s_counter\(4) & (\timer_fsm|s_counter\(6) & \timer_fsm|s_counter\(5))))
...
-- Equation(s):
-- \main_fsm|s_currentState~15_combout\ = (\KEY[0]~input_o\ & ((\main_fsm|Selector5~0_combout\) # ((\main_fsm|s_currentState.TRed1~q\ & !\timer_fsm|s_cntZero~q\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \main_fsm|Selector5~0_combout\,
	datab => \KEY[0]~input_o\,
...
-- Equation(s):
-- \main_fsm|WideOr2~0_combout\ = ((\main_fsm|s_currentState.TIntermit~q\) # ((\main_fsm|s_currentState.TGreen2~q\) # (\main_fsm|s_currentState.TYellow2~q\))) # (!\main_fsm|s_currentState.TInit~q\)
...
-- Equation(s):
-- \main_fsm|WideOr1~0_combout\ = (\main_fsm|s_currentState.TGreen1~q\) # ((\main_fsm|s_currentState.TIntermit~q\) # ((\main_fsm|s_currentState.TYellow1~q\) # (!\main_fsm|s_currentState.TInit~q\)))
...
PORT MAP (
	...
	datab => \main_fsm|s_currentState.TIntermit~q\,
	datac => \main_fsm|s_currentState.TYellow1~q\,
	datad => \main_fsm|s_currentState.TInit~q\,
