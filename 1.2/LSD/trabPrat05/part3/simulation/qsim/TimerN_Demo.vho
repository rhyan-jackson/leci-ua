...
SIGNAL \s_count[17]~35_combout\ : std_logic;
...
SIGNAL \s_count[17]~34_combout\ : std_logic;
...
\s_count[17]~35\ : cycloneive_lcell_comb
-- Equation(s):
-- \s_count[17]~35_combout\ = (\reset~input_o\) # ((\enable~input_o\ & ((\start~input_o\) # (!\Equal0~10_combout\))))
...
PORT MAP (
	...
	sclr => \s_count[17]~34_combout\,
	ena => \s_count[17]~35_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => s_count(1));
...
\s_count[17]~34\ : cycloneive_lcell_comb
-- Equation(s):
-- \s_count[17]~34_combout\ = (\reset~input_o\) # ((\Equal0~9_combout\ & ((s_count(3)) # (!\start~input_o\))))
...
-- Equation(s):
-- \Equal0~10_combout\ = (\Equal0~9_combout\ & !s_count(3))
...
-- Equation(s):
-- \timerOut~0_combout\ = (!\reset~input_o\ & (\enable~input_o\ & ((\Equal0~9_combout\) # (!\timerOut~reg0_q\))))
...
-- Equation(s):
-- \timerOut~1_combout\ = (\timerOut~0_combout\ & (\start~input_o\ & (\Equal0~10_combout\))) # (!\timerOut~0_combout\ & (((\timerOut~reg0_q\))))
