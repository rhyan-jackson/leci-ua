...
int main(int argc, char* argv[]) {
  ...
  Image image_0 = ImageCreateChessboard(8, 8, 2, WHITE);
  ImageRAWPrint(image_0);
  ImageRLEPrint(image_0);
  ...
  printf("image_1 AND image_white\n");
  Image image_4 = ImageAND(image_1, white_image);
  ImageRAWPrint(image_4);

  printf("image_1 OR image_0\n");
  Image image_5 = ImageAND(image_1, image_0);
